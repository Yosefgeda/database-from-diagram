...
# 📖 [database_from_diagram] <a name="about-project"></a>

**[database_from_diagram]** is database made from a schema diagram containing info about medical treatements.
...
```sh
  cd my-folder
  git clone https://github.com/Yidnekachew-cmd/database-from-diagram.git
```
...
Feel free to check the [issues page](https://github.com/Yidnekachew-cmd/database-from-diagram/issues).
